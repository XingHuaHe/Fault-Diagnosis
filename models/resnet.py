...
def _resnet18(arch: str, block: Type[Union[BasicBlock, Bottleneck]], layers: List[int], pretrained: str, **kwargs: Any) -> ResNet:
...
def resnet18(pretrained: str = '', **kwargs: Any) -> ResNet:
    return _resnet18('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, **kwargs)
